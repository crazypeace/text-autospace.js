(function (window, $) {
  ((init = function () {
    $(".han-la").each(function () {
      var filterEl = function (el) {
        var name = el.nodeName.toLowerCase(),
          cls = el.nodeType == 1 ? el.getAttribute("class") : "";
        return (
          name !== "style" &&
          name !== "script" &&
          name !== "h1" &&
    ...
    (findAndReplaceDOMText = function (a, b) {
      ...
      b.filterElements = function (el) {
        var name = el.nodeName.toLowerCase(),
          ...
          charized =
            classes && classes.match(/han-js-charized/) != null ? true : false;
